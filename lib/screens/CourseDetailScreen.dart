...
class _CourseDetailScreenState extends State<CourseDetailScreen>
  ...
  Future<void> _checkDownloadStatus() async {
    final isDownloaded = await LocalDatabase.isCourseDownloaded(
      widget.course.id,
    );
    setState(() {
  ...
  Future<void> _checkIfFavorite() async {
    try {
      ...
      final isFav = list.any(
        (item) => item.courseId.toString() == widget.course.id.toString(),
      );
